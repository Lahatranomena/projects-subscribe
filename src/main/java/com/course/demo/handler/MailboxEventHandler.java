package com.course.demo.handler;

import static com.course.demo.concurrency.ThreadRenamer.renameWorkerThread;
...
import com.course.demo.PojaApplication;
import com.course.demo.PojaGenerated;
import com.course.demo.endpoint.EndpointConf;
import com.course.demo.endpoint.event.EventConf;
import com.course.demo.endpoint.event.consumer.EventConsumer;
import com.course.demo.endpoint.event.consumer.model.ConsumableEvent;
import com.course.demo.endpoint.event.consumer.model.ConsumableEventTyper;

package com.course.demo.endpoint.event.consumer;

import com.course.demo.PojaGenerated;
import com.course.demo.endpoint.event.consumer.model.TypedEvent;
...
public class EventServiceInvoker implements Consumer<TypedEvent> {
  ...
  public void accept(TypedEvent typedEvent) {
    ...
    var eventClasses = getAllClasses("com.course.demo.endpoint.event.model");
  ...
  private String getEventService(String eventClazzName) {
    ...
    return "com.course.demo.service.event."

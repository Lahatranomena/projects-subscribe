...
import static com.course.demo.endpoint.event.EventStack.EVENT_STACK_1;
import static java.lang.Math.random;

import com.course.demo.PojaGenerated;
import com.course.demo.endpoint.event.EventStack;
...
public abstract class PojaEvent implements Serializable {
  ...
  public String getEventSource() {
    if (getEventStack().equals(EVENT_STACK_1)) return "com.course.demo.event1";
    return "com.course.demo.event2";
  }
}
